                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="user_profile.php" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $dec_user;?></span>
                ...
                $.post('cek_account.php',
                    ...
                    function(data) {
                        if (data == 'false') {
                            ...
                            $("#alertAcc").html("<div class='alert alert-danger my-3' role='alert'>You can't transfer to your own account!</div>");
                            accdone = false;
                            cekFields();
                        } else {

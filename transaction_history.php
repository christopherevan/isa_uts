...
$sql = "SELECT a.account_id, c.name FROM users as u INNER JOIN customers as c ON u.username=c.username 
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="user_profile.php" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small" id="user_name"><?php echo $dec_user?></span>
